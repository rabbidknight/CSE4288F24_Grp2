...
# Split the image names into training and validation sets (80% training, 20% validation)
train_images, validation_images = train_test_split(image_names, test_size=0.2, random_state=42)
